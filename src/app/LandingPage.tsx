    ...
    <div style={{
      ...
      <nav style={{
        ...
        <div style={{
          ...
          fontFamily: "'Fredoka One', sans-serif", fontSize: '22px', color: '#1a1a1a',
        }}>
          <div style={{
      ...
      {/* ── HERO ── */}
      <div style={{
        background: 'linear-gradient(160deg, #1a5c2a 0%, #2d8c45 50%, #3aaa58 100%)',
        ...
        <div style={{ position: 'absolute', top: '40px', left: '20%', width: '150px', height: '150px', borderRadius: '50%', background: 'rgba(255,225,53,0.08)' }} />

        <div style={{ position: 'relative', zIndex: 1, maxWidth: '760px', margin: '0 auto' }}>
          <div style={{
            display: 'inline-block',
            background: 'rgba(255,225,53,0.2)',
            border: '1.5px solid rgba(255,225,53,0.4)',
            color: '#FFE135',
          ...
          <h1 style={{
            ...
            <span style={{ color: '#FFE135', display: 'block' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
            <button
              ...
              style={{
                ...
                cursor: 'pointer',
                boxShadow: '0 6px 0 #c9a800, 0 8px 24px rgba(0,0,0,0.2)',
                transition: 'all 0.2s',
              }}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '16px' }}>
            {[
              ...
              <div key={i} style={{
                ...
                border: `2px solid ${band.color}22`,
              }}>
      ...
      <div style={{ background: '#f5f5f0', padding: '80px 48px' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', textAlign: 'center' }}>
          <h2 style={{ fontFamily: "'Fredoka One', sans-serif", fontSize: 'clamp(26px, 4vw, 38px)', color: '#1a1a1a', marginBottom: '12px' }}>
            Wave 1 subjects — live at launch
          </h2>
          <p style={{ fontSize: '16px', fontWeight: 700, color: '#666', marginBottom: '40px', lineHeight: 1.7 }}>
            Eight subjects, four age bands, hundreds of sessions. More waves coming throughout the year.
          </p>
      ...
      <div style={{ padding: '80px 48px', maxWidth: '800px', margin: '0 auto' }}>
        <div style={{
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            <div style={{
              fontFamily: "'Fredoka One', sans-serif",
              fontSize: '13px', color: '#FFE135',
              letterSpacing: '0.08em', textTransform: 'uppercase',
              marginBottom: '20px',
            }}>A message from the founders</div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              <div style={{
                ...
                <div style={{
                  ...
                  background: '#FFE135', border: '3px solid rgba(255,255,255,0.3)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  fontFamily: "'Fredoka One', sans-serif", fontSize: '18px', color: '#1a5c2a',
                }}>R</div>
                <div style={{
                  width: '48px', height: '48px', borderRadius: '50%',
                  background: 'rgba(255,255,255,0.2)', border: '3px solid rgba(255,255,255,0.3)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  fontFamily: "'Fredoka One', sans-serif", fontSize: '18px', color: '#fff',
                }}>J</div>
              </div>
              <div>
                ...
                <div style={{ fontSize: '13px', fontWeight: 700, color: 'rgba(255,255,255,0.6)' }}>
                  ...
                  <a href="https://perfectedchaos.co.uk" target="_blank" rel="noopener noreferrer" style={{ color: '#FFE135', textDecoration: 'none' }}>
                    Perfected Chaos
                  </a>
                </div>
              </div>
      ...
      <div style={{ background: '#f5f5f0', padding: '80px 48px' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '16px', fontWeight: 700, color: '#666', marginBottom: '40px', lineHeight: 1.7 }}>
            One family. All ages. All subjects. One price.
          </p>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
            {[
              ...
              <div key={i} style={{
                background: plan.highlight ? 'linear-gradient(135deg, #1a5c2a, #2d8c45)' : '#fff',
                borderRadius: '22px', padding: '32px 24px',
                border: plan.highlight ? 'none' : '2px solid #e0e0e0',
                boxShadow: plan.highlight ? '0 8px 0 #0d3d1c, 0 12px 28px rgba(0,0,0,0.15)' : '0 2px 12px rgba(0,0,0,0.06)',
                position: 'relative',
              }}>
                {plan.highlight && (
                  <div style={{
          ...
          <div style={{ fontSize: '14px', fontWeight: 700, color: '#888', marginBottom: '32px' }}>
          ...
          <button
            ...
            style={{
              ...
              cursor: 'pointer',
              boxShadow: '0 6px 0 #1a5c2a, 0 8px 24px rgba(0,0,0,0.15)',
              transition: 'all 0.2s',
            }}
            onMouseEnter={e => (e.currentTarget.style.transform = 'translateY(-2px)')}
            onMouseLeave={e => (e.currentTarget.style.transform = 'translateY(0)')}
      ...
      <div style={{ padding: '80px 48px', maxWidth: '720px', margin: '0 auto' }}>
        <h2 style={{ fontFamily: "'Fredoka One', sans-serif", fontSize: 'clamp(26px, 4vw, 36px)', color: '#1a1a1a', marginBottom: '36px', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          {[
            ...
            { q: 'Can siblings share one account?', a: 'Yes — one family subscription covers all your children. Each learner has their own profile, character and progress. You can switch between learners from the parent dashboard.' },
      ...
      <div style={{
        ...
        <h2 style={{ fontFamily: "'Fredoka One', sans-serif", fontSize: 'clamp(28px, 4vw, 44px)', color: '#fff', marginBottom: '16px' }}>
        ...
        <button
          ...
          style={{
            ...
            fontFamily: "'Fredoka One', sans-serif", fontSize: '22px',
            cursor: 'pointer',
            boxShadow: '0 6px 0 #c9a800, 0 8px 28px rgba(0,0,0,0.2)',
            transition: 'all 0.2s',
          }}
          onMouseEnter={e => (e.currentTarget.style.transform = 'translateY(-2px)')}
          onMouseLeave={e => (e.currentTarget.style.transform = 'translateY(0)')}
        ...
        <div style={{ marginTop: '20px', fontSize: '13px', fontWeight: 700, color: 'rgba(255,255,255,0.55)' }}>
          £5.99/month after trial · Cancel any time
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ fontFamily: "'Fredoka One', sans-serif", fontSize: '18px', color: '#fff' }}>
        ...
        <div style={{ fontSize: '13px', fontWeight: 700, color: 'rgba(255,255,255,0.4)', textAlign: 'center' }}>
          ...
          <a href="https://perfectedchaos.co.uk" target="_blank" rel="noopener noreferrer" style={{ color: 'rgba(255,255,255,0.5)', textDecoration: 'none' }}>
            Perfected Chaos
          </a>
        </div>
        <div style={{ fontSize: '13px', fontWeight: 700, color: 'rgba(255,255,255,0.4)' }}>
          &copy; 2026 HomeGrownSkills
        </div>
      </div>
