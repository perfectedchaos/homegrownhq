...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div style={{
      ...
      >
        <div style={{ fontFamily: "'Fredoka One', sans-serif", fontSize: '17px', color: '#1a1a1a' }}>{question}</div>
        <div style={{
      ...
      {open && (
        <div style={{
          ...
          fontSize: '14px', fontWeight: 700, color: '#555', lineHeight: 1.7,
  ...
  return (
    <div style={{
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', fontFamily: "'Fredoka One', sans-serif", fontSize: '22px', color: '#1a1a1a' }}>
          <div style={{ width: '32px', height: '32px', background: '#FFE135', borderRadius: '50% 0 50% 50%', transform: 'rotate(-45deg)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <a href="#learner-login" onClick={(e) => { e.preventDefault(); onLearnerLogin(); }} style={{ padding: '8px 16px', borderRadius: '20px', background: '#edfaf1', border: '2px solid #81C784', color: '#1b5e20', fontSize: '13px', fontWeight: 800, cursor: 'pointer', textDecoration: 'none' }}>
            🌱 Learner Login
          </a>
          <a href="#login" onClick={(e) => { e.preventDefault(); onLogin(); }} style={{ padding: '10px 18px', borderRadius: '20px', background: 'transparent', color: '#1a1a1a', border: '2px solid #e0e0e0', fontFamily: "'Fredoka One', sans-serif", fontSize: '15px', cursor: 'pointer', textDecoration: 'none' }}>
            Log In
          </a>
          <a href="#signup" onClick={(e) => { e.preventDefault(); onGetStarted(); }} style={{ padding: '10px 18px', borderRadius: '20px', background: '#2d8c45', color: '#fff', fontFamily: "'Fredoka One', sans-serif", fontSize: '15px', cursor: 'pointer', textDecoration: 'none' }}>
            Start Free Trial
          </a>
        </div>
      </nav>
      ...
      <div style={{ background: 'linear-gradient(160deg, #1a5c2a 0%, #2d8c45 50%, #3aaa58 100%)', padding: '80px 48px 100px', position: 'relative', overflow: 'hidden', textAlign: 'center' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '760px', margin: '0 auto' }}>
          <div style={{ display: 'inline-block', background: 'rgba(255,225,53,0.2)', border: '1.5px solid rgba(255,225,53,0.4)', color: '#FFE135', fontSize: '13px', fontWeight: 900, padding: '6px 18px', borderRadius: '30px', letterSpacing: '0.06em', textTransform: 'uppercase', marginBottom: '20px' }}>
          ...
          <p style={{ fontSize: '18px', fontWeight: 700, color: 'rgba(255,255,255,0.8)', lineHeight: 1.7, marginBottom: '36px', maxWidth: '580px', margin: '0 auto 36px' }}>
          ...
          <div style={{ fontSize: '13px', fontWeight: 700, color: 'rgba(255,255,255,0.6)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '20px', flexWrap: 'wrap' }}>
      ...
      <div style={{ padding: '80px 48px', maxWidth: '1100px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '56px' }}>
          ...
          <p style={{ fontSize: '17px', fontWeight: 700, color: '#666', maxWidth: '580px', margin: '0 auto', lineHeight: 1.7 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(240px, 1fr))', gap: '20px' }}>
          {[
            ...
            <div key={i} style={{ background: section.bg, borderRadius: '22px', padding: '28px 24px', border: `2px solid ${section.color}22` }}>
              ...
              <div style={{ fontSize: '14px', fontWeight: 700, color: '#444', lineHeight: 1.6 }}>{section.desc}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      <div style={{ background: '#f5f5f0', padding: '80px 48px' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            ...
            <p style={{ fontSize: '16px', fontWeight: 700, color: '#666', maxWidth: '520px', margin: '0 auto', lineHeight: 1.7 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '16px' }}>
            {[
              ...
              <div key={i} style={{ background: band.bg, borderRadius: '20px', padding: '24px 20px', border: `2px solid ${band.color}22` }}>
                <div style={{ fontSize: '36px', marginBottom: '8px' }}>{band.icon}</div>
                <div style={{ fontFamily: "'Fredoka One', sans-serif", fontSize: '20px', color: band.color, marginBottom: '2px' }}>{band.name}</div>
                <div style={{ fontSize: '12px', fontWeight: 800, color: band.color, opacity: 0.7, marginBottom: '10px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>{band.ages}</div>
                <div style={{ fontSize: '13px', fontWeight: 700, color: '#444', lineHeight: 1.6 }}>{band.desc}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div id="what-to-expect" style={{ padding: '80px 48px', maxWidth: '1100px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
          {[
            ...
            <div key={i} style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', background: '#fff', borderRadius: '20px', padding: '28px', boxShadow: '0 2px 16px rgba(0,0,0,0.06)', border: '1px solid rgba(0,0,0,0.05)' }}>
              <div style={{ width: '60px', height: '60px', borderRadius: '18px', background: `${step.color}15`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '28px', flexShrink: 0 }}>{step.icon}</div>
              <div>
                <div style={{ fontSize: '11px', fontWeight: 900, color: step.color, letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: '4px' }}>Step {step.step}</div>
                <div style={{ fontFamily: "'Fredoka One', sans-serif", fontSize: '22px', color: '#1a1a1a', marginBottom: '6px' }}>{step.title}</div>
                <div style={{ fontSize: '15px', fontWeight: 700, color: '#555', lineHeight: 1.6 }}>{step.desc}</div>
              </div>
            </div>
          ))}
        </div>
      ...
      <div style={{ background: '#f5f5f0', padding: '80px 48px' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '16px', fontWeight: 700, color: '#666', marginBottom: '40px', lineHeight: 1.7 }}>Eight subjects, four age bands, hundreds of sessions. More waves coming throughout the year.</p>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '14px' }}>
            {[
              ...
              <div key={i} style={{ background: '#fff', borderRadius: '16px', padding: '20px 16px', border: '1.5px solid rgba(0,0,0,0.06)', textAlign: 'center' }}>
                <div style={{ fontSize: '32px', marginBottom: '8px' }}>{subject.icon}</div>
                <div style={{ fontFamily: "'Fredoka One', sans-serif", fontSize: '16px', color: '#1a5c2a', marginBottom: '5px' }}>{subject.name}</div>
                <div style={{ fontSize: '12px', fontWeight: 700, color: '#888', lineHeight: 1.5 }}>{subject.desc}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div style={{ padding: '80px 48px', maxWidth: '800px', margin: '0 auto' }}>
        <div style={{ background: 'linear-gradient(135deg, #1a5c2a, #2d8c45)', borderRadius: '28px', padding: '48px', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            <div style={{ fontFamily: "'Fredoka One', sans-serif", fontSize: '13px', color: '#FFE135', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: '20px' }}>A message from the founders</div>
            <blockquote style={{ fontSize: '18px', fontWeight: 700, color: 'rgba(255,255,255,0.92)', lineHeight: 1.8, marginBottom: '28px', fontStyle: 'italic', borderLeft: '4px solid #FFE135', paddingLeft: '20px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <div>
                <div style={{ fontFamily: "'Fredoka One', sans-serif", fontSize: '18px', color: '#fff' }}>Rob & Jodie</div>
            ...
            <div style={{ marginTop: '24px', background: 'rgba(255,255,255,0.08)', borderRadius: '14px', padding: '14px 18px', fontSize: '14px', fontWeight: 700, color: 'rgba(255,255,255,0.75)', lineHeight: 1.6 }}>
      ...
      <div style={{ background: '#f5f5f0', padding: '80px 48px' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '16px', fontWeight: 700, color: '#666', marginBottom: '40px', lineHeight: 1.7 }}>One family. All ages. All subjects. One price.</p>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
            {[
              ...
              <div key={i} style={{ background: plan.highlight ? 'linear-gradient(135deg, #1a5c2a, #2d8c45)' : '#fff', borderRadius: '22px', padding: '32px 24px', border: plan.highlight ? 'none' : '2px solid #e0e0e0', boxShadow: plan.highlight ? '0 8px 0 #0d3d1c, 0 12px 28px rgba(0,0,0,0.15)' : '0 2px 12px rgba(0,0,0,0.06)', position: 'relative' }}>
                {plan.highlight && <div style={{ position: 'absolute', top: '-12px', left: '50%', transform: 'translateX(-50%)', background: '#FFE135', color: '#1a5c2a', fontSize: '12px', fontWeight: 900, padding: '4px 16px', borderRadius: '20px', whiteSpace: 'nowrap' }}>Best value</div>}
                <div style={{ fontFamily: "'Fredoka One', sans-serif", fontSize: '18px', color: plan.highlight ? 'rgba(255,255,255,0.7)' : '#666', marginBottom: '8px' }}>{plan.label}</div>
                ...
                <div style={{ fontSize: '13px', fontWeight: 700, color: plan.highlight ? 'rgba(255,255,255,0.6)' : '#888' }}>{plan.sub}</div>
              </div>
            ))}
          </div>
          <div style={{ fontSize: '14px', fontWeight: 700, color: '#888', marginBottom: '32px' }}>✅ 7-day free trial · No card required · Cancel any time</div>
      ...
      <div style={{ background: 'linear-gradient(135deg, #1a5c2a, #2d8c45)', padding: '80px 48px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: '17px', fontWeight: 700, color: 'rgba(255,255,255,0.75)', marginBottom: '36px', maxWidth: '480px', margin: '0 auto 36px', lineHeight: 1.7 }}>
        ...
        <div style={{ marginTop: '20px', fontSize: '13px', fontWeight: 700, color: 'rgba(255,255,255,0.55)' }}>£5.99/month after trial · Cancel any time</div>
      </div>
      ...
      <div style={{ background: '#0a2e14', padding: '32px 48px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '16px' }}>
        <div style={{ fontFamily: "'Fredoka One', sans-serif", fontSize: '18px', color: '#fff' }}>HomeGrown<span style={{ color: '#FFE135' }}>Skills</span></div>
        <div style={{ fontSize: '13px', fontWeight: 700, color: 'rgba(255,255,255,0.4)', textAlign: 'center' }}>
        ...
        <div style={{ fontSize: '13px', fontWeight: 700, color: 'rgba(255,255,255,0.4)' }}>&copy; 2026 HomeGrownSkills</div>
      </div>
